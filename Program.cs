...
namespace SFDemo1
{
    class QuickstartApiSample
    {
        ...
        private bool login()
        {
            ...
            string username = "atiraj.kumar@synechron.com.syndevint";
            //Console.Write("Enter password: ");
            string password = "abcd1234NP2jEhfOPE4p6XX4uciM74T6";//Console.ReadLine();
        ...
        */
        private void describeGlobalSample()
        {
            try
            {
                ...
                LimitInfo[] limInfo = client.describeGlobal(
        ...
        */
        ...
        public void CreateContact()
        {
            ...
            ct.FirstName="Bhushan";
            ct.LastName = "Patki";
            sObject[] obj=new sObject[1];
            obj[0] = ct;
            client.create(header, null, null, null, null, null, null, null, null, null, obj, out info, out result);
            Console.WriteLine(result[0].success.ToString());
